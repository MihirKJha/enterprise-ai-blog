...
# 2.4 — Structuring Metadata & Document-Aware Retrieval
...
graph TD
    A[User<br/>Query]
    B[Query<br/>Understanding]
    C[Metadata<br/>Constraints]
    D[Semantic<br/>Retrieval]
    E[Candidate<br/>Chunks]
...
graph TD
    A[User<br/>Query]
    B[Metadata<br/>Filter]
    C[Semantic<br/>Search]
    D[Candidate Intersection / Merge]
    E[Relevant<br/>Evidence]
    F[Parent / Source<br/>Context]
